...
/**
 * Plugin implementation of the 'default_license_plate_widget'
widget.
 *
 * @FieldWidget(
...
class DefaultLicensePlateWidget extends WidgetBase
{
    ...
    public function settingsSummary()
    {
        ...
        $placeholder_settings = $this->getSetting('placeholder');
        if (
            !empty($placeholder_settings['number']) &&
            !empty($placeholder_settings['code'])
        ) {
    ...
    public function formElement(
        ...
        $element['details'] = [
            '#type' => 'details',
            '#title' => $element['#title'],
            '#open' => $this->getSetting('fieldset_state') == 'open' ?
                TRUE : FALSE,
